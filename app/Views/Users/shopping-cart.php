                                    ...
                                    <tr class="tf-cart-item file-delete">
                                        <td class="tf-cart-item_product">
                                            ...
                                            <div class="cart-info">
                                                ...
                                                <span class="remove-cart" onclick="handleUpdate('<?= $value->id ?>', 'delete')">Xóa</span>
                                            </div>
                                        </td>
                    ...
                    <div class="tf-page-cart-footer">
                        <div class="tf-cart-footer-inner">
                            ...
                            <div class="tf-page-cart-checkout">
                                ...
                                <!-- <p class="tf-cart-tax">Taxes and <a href="shipping-delivery.html">shipping</a>  calculated at checkout</p> -->
                                <?php if(count($data) > 0): ?>
                                <div class="cart-checkbox">
